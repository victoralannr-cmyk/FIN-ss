...
export const App: React.FC = () => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-6 bg-[var(--bg-main)] text-[var(--text-primary)]">
        <Card className="w-full max-w-md bg-[var(--bg-card)] border-[var(--border-color)] p-8 sm:p-12 space-y-12 rounded-[2.5rem] animate-scale-in">
          ...
          <div className="space-y-4">
             <p className="text-[10px] text-[var(--text-secondary)] uppercase tracking-widest text-center">Seu Nome</p>
             <input 
               type="text" 
          ...
          <button 
            ...
            className="btn-modern w-full py-6 font-bold rounded-full shadow-lg uppercase tracking-wider"
          >
            Acessar Sistema
          </button>
        </Card>
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-main)] text-[var(--text-primary)] flex flex-col lg:flex-row font-sans overflow-hidden">
              ...
              <Card className="bg-[var(--bg-card)] border-[var(--border-color)] rounded-[2.5rem] p-8 lg:p-10 shadow-sm flex flex-col max-h-[320px] card-hover animate-fade-up stagger-2">
                ...
                <div className="flex-1 overflow-y-auto space-y-4 no-scrollbar">
                   {transactions.length === 0 ? (
                     <p className="text-[10px] text-[var(--text-secondary)] uppercase italic py-4">Nenhum registro ainda.</p>
                   ) : (
            ...
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 lg:gap-10">
              <Card className="bg-[var(--bg-card)] border border-[var(--border-color)] rounded-[2.5rem] lg:rounded-[3rem] p-8 lg:p-12 flex flex-col shadow-sm card-hover animate-fade-up stagger-5">
                ...
                <div className="space-y-6 lg:space-y-8 flex-1">
                  {tasks.length === 0 ? (
                    <p className="text-xs text-[var(--text-secondary)] uppercase italic">Nenhuma diretriz pendente.</p>
                  ) : (
               ...
               <Card className="bg-[var(--bg-card)] border border-[var(--border-color)] rounded-[2.5rem] lg:rounded-[3rem] p-8 lg:p-12 shadow-sm h-[450px] lg:h-[500px] flex flex-col card-hover animate-scale-in stagger-1">
                 ...
                 <div className="flex-1 overflow-y-auto space-y-4 no-scrollbar">
                   {currentMonthTransactions.length === 0 ? (
                     <p className="text-[10px] text-[var(--text-secondary)] uppercase italic py-8">Sem lançamentos este mês.</p>
                   ) : (
      ...
      <nav className="lg:hidden fixed bottom-0 left-0 right-0 h-24 bg-[var(--bg-main)]/95 backdrop-blur-3xl border-t border-[var(--border-color)] flex items-center justify-around px-2 pb-6 z-[400] shadow-xl animate-fade-up">
        {[
          { id: 'dashboard', icon: LayoutDashboard, label: 'Painel' },
